...
C
     ...
     2         IPAGE(80,200),REST(73),IOP,TITLE(80),ISYM(8,20)
     3         ,IBUF(8,20),PATNUM(80),COMP(80)
      INTEGER BEL,IFUNCT,IDESC,IEND
      INTEGER J,I,IC,IL,IBLOW,IPCTR,ILE,COUNT,ILE,ITYPE,ILL
     1        ,IMATCH,IPRD,I88PRO,IINPUT,I8PRO,ILERR,ISAF
     2        ,IPCTR1,IPCTR0,ISA0,ISA1,IFAULT
...
C      PAL16X4 AND PAL16A4
      IMPLICIT INTEGER (A-Z)
      LOGICAL LBUF(20),LFUSES(32,64),LFIRST,LMATCH,LFIX,LPROD(80)
      CHARACTER A,B,ISLASH,IOR,IBLANK,IRIGHT,TITLE(80)
...
C     THIS SUBROUTINE PRINTS THE PAL DESIGN SPECIFICATION INPUT FILE
      IMPLICIT INTEGER (A-Z)
      CHARACTER IPAL(4),IOT,INOAI,INOO
